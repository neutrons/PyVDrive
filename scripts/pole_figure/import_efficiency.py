...
vulcan_eff_file = h5py.File('/SNS/users/wzz/Projects/VULCAN/PoleFigure/vulcan_eff_156473.hdf5', 'r')
...
eff_ws = CreateWorkspace(DataX=range(1, efficiency.size+1), DataY=efficiency, NSpec=efficiency.size)
