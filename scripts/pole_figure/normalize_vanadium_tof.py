...
# group detectors
GroupDetectors(InputWorkspace='log_van_eff_calib', OutputWorkspace='long_van_tof_eff_calib', CopyGroupingFromWorkspace='pole_figure_group')
...
for iws in range(norm_long_van.getNumberHistograms()):
    ...
    for iy in range(len(norm_long_van.dataY(iws))):
        norm_long_van.dataY(iws)[iy] /= num_det
