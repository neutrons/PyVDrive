...
# vanadium
Load(Filename='/SNS/VULCAN/IPTS-21356/nexus/VULCAN_161350.nxs.h5',
     OutputWorkspace='long_van')
...
MaskDetectors(Workspace='long_van', MaskedWorkspace='highanglemask',
              ForceInstrumentMasking=True)
# align detectors
AlignDetectors(InputWorkspace='long_van', OutputWorkspace='long_van',
               CalibrationWorkspace='pole_figure_cal')
# convert back to TOF and rebin
ConvertUnits(InputWorkspace='long_van',
             OutputWorkspace='long_van', Target='TOF')
Rebin(InputWorkspace='long_van', OutputWorkspace='long_van',
      Params='5000,-0.001,60000')
# convert to Workspace2D in order to apply efficiency factor
ConvertToMatrixWorkspace(InputWorkspace='long_van',
                         OutputWorkspace='long_van_matrix')
# eff_ws is generated by script import_efficiency.py
Multiply(LHSWorkspace='long_van_matrix', RHSWorkspace='eff_ws',
         OutputWorkspace='log_van_eff_calib')
...
norm_long_van = CloneWorkspace(
    InputWorkspace='long_van_tof_eff_calib', OutputWorkspace='norm_long_van')
