...
# Step 2
PYTHONPATH=$VULCANPATH:$PYTHONPATH python ./scripts/calibration/vulcan_cal_evalulate_calibration.py --nexus=/SNS/VULCAN/IPTS-22752/nexus/VULCAN_171866.nxs.h5 --calib=VULCAN_Calibration_2019-1-22_7-7-39.h5
