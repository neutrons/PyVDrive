...
PYTHONPATH=$MANTIDPATH:$PVPATH:$PYTHONPATH python ./scripts/calibration/vulcan_cal_instrument_calibration.py --test=1 --nexus=/SNS/VULCAN/IPTS-22752/nexus/VULCAN_171866.nxs.h5 --focus=3 --ref=/SNS/VULCAN/shared/CALIBRATION/2018_9_10_CAL/VULCAN_calibrate_2018_09_12.h5


# PYTHONPATH=$MANTIDPATH:$PYTHONPATH python ./scripts/calibration/vulcan_cal_bank_calibration.py $CMDS

# Step 2
# PYTHONPATH=$VULCANPATH:$PYTHONPATH python ./scripts/calibration/vulcan_cal_evalulate_calibration.py $CMDS
