...
LoadDiffCal(InputWorkspace='vulcan_diamond',
            Filename=template_calib_3bank_file, WorkspaceName='vulcan_template')
LoadDiffCal(InputWorkspace='vulcan_diamond', Filename=new_calib_file,
            WorkspaceName='vulcan{0}'.format(flag))

# Align
AlignDetectors(InputWorkspace='vulcan_diamond', OutputWorkspace='vulcan_diamond',
               CalibrationWorkspace='vulcan{0}_cal'.format(flag))
