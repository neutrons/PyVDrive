...
# Load data
LoadEventNexus(Filename='/SNS/VULCAN/IPTS-{}/nexus/VULCAN_{}.nxs.h5'.format(IPTS,
               Run), OutputWorkspace='si')
# Load calibration
LoadDiffCal(InputWorkspace='si',
            Filename='/SNS/VULCAN/shared/CALIBRATION/2019_1_20/VULCAN_calibrate_2019_01_21.h5', WorkspaceName='vulcan_')
...
for peak_position, peak_width in Peaks:
    ...
    FitPeaks(InputWorkspace='si',
             ...
             FitWindowBoundaryList='{}, {}'.format(
                 peak_position - peak_width, peak_positon + peak_width),
