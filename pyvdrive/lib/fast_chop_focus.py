...
def reduce_data(ws_name_list, bin_table_name, ipts_number, gsas_iparm_file_name):
    """
...
def chop_focus_save(event_file_name, event_ws_name, split_ws_name, info_ws_name,
    ...
    num_banks = 3
    not_align_idl = False
    bin_table_name = create_bin_table(num_banks, not_align_idl,
                                      idl_bin_file_name,
    ...
    for thread_id in range(num_threads):
        ...
        thread_pool[thread_id] = threading.Thread(target=reduce_data,
