...
class AutoReduce(VDriveCommand):
    """
    ...
    def __init__(self, controller, command_args):
        ...
        :param command_args:
        """
        super(AutoReduce, self).__init__(controller, command_args)
...
class VBin(VDriveCommand):
    ...
    def set_merge_flag(self, flag):
        """
        set the flag whether the runs will be merged or not
        :param flag:
        :return:
        """
        datatypeutility.check_bool_variable('Flag to merge runs', flag)
